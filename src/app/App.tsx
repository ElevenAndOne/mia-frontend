...
import VideoIntroView from '../features/auth/video-intro-view'
import CombinedAccountSelection from '../features/accounts/combined-account-selection'
import MetaAccountSelectionPage from '../features/accounts/meta-account-selection-page'
...
const MainViewCopy = lazy(() => import('../features/dashboard/main-view-copy'))
const IntegrationsPage = lazy(() => import('../features/integrations/integrations-page'))
const GrowInsightsStreaming = lazy(() => import('../features/insights/grow-insights-streaming'))
const OptimizeInsightsStreaming = lazy(() => import('../features/insights/optimize-insights-streaming'))
const ProtectInsightsStreaming = lazy(() => import('../features/insights/protect-insights-streaming'))
const SummaryInsights = lazy(() => import('../features/insights/summary-insights'))
const InsightsDatePickerModal = lazy(() => import('../features/insights/insights-date-picker-modal'))
const OnboardingChat = lazy(() => import('../features/onboarding/onboarding-chat-v2'))
const InviteLandingPage = lazy(() => import('../features/accounts/invite-landing-page'))
const WorkspaceSettingsPage = lazy(() => import('../features/workspaces/workspace-settings-page'))
...
function App() {
  const { isAuthenticated, isMetaAuthenticated, selectedAccount, isLoading, hasSeenIntro, activeWorkspace, availableWorkspaces } = useSession()
  ...
  }, [isAuthenticated, isMetaAuthenticated, selectedAccount, isLoading, appState, hasSeenIntro, activeWorkspace, availableWorkspaces, isAnyAuthenticated, justAcceptedInvite])
