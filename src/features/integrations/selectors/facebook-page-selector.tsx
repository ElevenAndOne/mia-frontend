...
interface FacebookPageSelectorProps {
  ...
  currentAccountData?: { id?: string | number; name?: string; facebook_page_id?: string } | null  // Fresh account data from IntegrationsPage
}
...
const FacebookPageSelector = ({ isOpen, onClose, onSuccess, currentAccountName, currentAccountData }: FacebookPageSelectorProps) => {
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchFacebookPages is intentionally omitted to prevent re-fetching on every render
  }, [isOpen])
