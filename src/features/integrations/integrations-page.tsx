    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4">
        ...
        <div className="mb-4 max-w-3xl mx-auto w-full">
          ...
          <p className="paragraph-xs text-quaternary mb-3">Having trouble connecting your data sources? Here are some helpful resources:</p>
          ...
          <div className="space-y-2 pl-2">
            ...
            <button className="w-full bg-secondary border border-secondary rounded-xl p-3 text-left hover:bg-tertiary">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center shrink-0">
                  <svg className="w-4 h-4 text-tertiary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
