...
interface FacebookPageSelectorProps {
  ...
  currentAccountData?: AccountData  // Fresh account data from IntegrationsPage
}
...
const FacebookPageSelector = ({ isOpen, onClose, onSuccess, currentAccountName, currentAccountData }: FacebookPageSelectorProps) => {
  ...
  const fetchFacebookPages = async (forceRefresh: boolean = false) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load Facebook Pages. Please try again.'
  ...
  const handleLinkPage = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to link Facebook Page. Please try again.'
      setError(errorMessage)
    } finally {
      setIsLinking(false)
    }
