...
const MailchimpAccountSelector = ({ isOpen, onClose, onSuccess }: MailchimpAccountSelectorProps) => {
  ...
  const fetchMailchimpAccounts = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load Mailchimp accounts. Please try again.'
  ...
  const handleSwitchAccount = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to switch account. Please try again.'
      setError(errorMessage)
    } finally {
  ...
  const handleRemoveAccount = async (mailchimpId: number, accountName: string) => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to remove account. Please try again.'
      setError(errorMessage)
    }
  }
