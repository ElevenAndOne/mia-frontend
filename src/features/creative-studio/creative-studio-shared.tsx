...
export const VIDEO_MODELS = [
  {
    ...
    icon: '🎬',
    badge: 'Cinematic',
    description: "Google's cinematic AI via fal.ai",
    maxDuration: 8,
    minDuration: 1,
  ...
  },
  {
    ...
    icon: '🎥',
    badge: 'Fast',
    description: 'Creative video via Runway API',
    maxDuration: 16,
    minDuration: 1,
  ...
  },
  {
    ...
    icon: '🎞️',
    badge: 'Creative',
    description: 'Kuaishou cinematic via fal.ai',
    maxDuration: 10,
    minDuration: 1,
    supportsReferences: true,
  },
...
export const IMAGE_MODELS = [
  {
    ...
    icon: '🎨',
    badge: 'Creative',
    description: "OpenAI's creative image model",
    supportsReferences: true,
  ...
  },
  {
    ...
    icon: '📸',
    badge: 'Quality',
    description: 'Black Forest Labs via fal.ai',
    supportsReferences: true,
    supportsEditing: true,
  },
  {
    ...
    icon: '🖼️',
    badge: 'Quality',
    description: "Google's image model via fal.ai",
    supportsReferences: true,
    supportsEditing: true,
  },
  {
    ...
    icon: '🍌',
    badge: 'Fast',
    description: 'Google fast image gen via fal.ai',
    supportsReferences: false,
  ...
  },
  {
    ...
    description: 'Gemini 3 Pro — up to 4K photorealism',
    supportsReferences: false,
    supportsEditing: false,
  },
]
...
export const vfxTemplates = [
  {
    ...
    video: `${S3}/vfx/earth-zoom-out.mp4`,
    prompt:
      "dramatic zoom out from ground level to Earth's orbit, pulling back to reveal the planet from space",
  },
  {
    id: 'disintegrate',
    name: 'Disintegrate',
    description: 'Dissolve to particles',
    video: `${S3}/vfx/disintegrate.mp4`,
    prompt: 'object or person dissolving into floating particles that drift away and disappear',
  },
  {
    id: 'eyes-in',
    name: 'Eyes In',
    description: 'Zoom into the eyes',
    video: `${S3}/vfx/eyes-in.mp4`,
    prompt:
      "dramatic zoom into the subject's eyes, revealing reflection or transitioning through the pupil",
  },
  {
    id: 'face-punch',
    name: 'Face Punch',
    description: 'Bullet-time impact',
    video: `${S3}/vfx/face-punch.mp4`,
    prompt:
      'slow motion punch impact with ripple effect, bullet-time style with debris and particles',
  },
  {
    id: 'lens-crack',
    name: 'Lens Crack',
    description: 'Glass shatter effect',
    video: `${S3}/vfx/lens-crack.mp4`,
    prompt: 'camera lens or glass cracking and shattering with light refraction through the cracks',
  },
  {
    id: 'paint-splash',
    name: 'Paint Splash',
    description: 'Liquid color burst',
    video: `${S3}/vfx/paint-splash.mp4`,
    prompt:
      'explosive paint or liquid color splash, vibrant colors bursting and mixing in slow motion',
  },
]
...
export const cameraMovements = [
  {
    id: 'bullet-time',
    name: 'Bullet Time',
    description: 'Slow motion with rotation',
    video: `${S3}/cam/bullet-time.mp4`,
  },
  {
    id: 'crane-down',
    name: 'Crane Down',
    description: 'Descend toward subject',
    video: `${S3}/cam/crane-down.mp4`,
  },
  {
    id: 'crane-up',
    name: 'Crane Up',
    description: 'Rise above subject',
    video: `${S3}/cam/crane-up.mp4`,
  },
  {
    id: 'dolly-in',
    name: 'Dolly In',
    description: 'Move toward subject',
    video: `${S3}/cam/dolly-in.mp4`,
  },
  {
    id: 'dolly-out',
    name: 'Dolly Out',
    description: 'Move away from subject',
    video: `${S3}/cam/dolly-out.mp4`,
  },
  {
    id: 'focus-shift',
    name: 'Focus Shift',
    description: 'Change focus point',
    video: `${S3}/cam/focus-shift.mp4`,
  },
  {
    id: 'fpv-drone',
    name: 'FPV Drone',
    description: 'First-person drone view',
    video: `${S3}/cam/fpv-drone.mp4`,
  },
  {
    id: 'lazy-susan',
    name: 'Lazy Susan',
    description: 'Smooth circular rotation',
    video: `${S3}/cam/lazy-susan.mp4`,
  },
]
    ...
    'veo-3.1': [
      {
        category: 'Cinematic',
        template:
          'Cinematic shot: [subject], dramatic lighting, 4K quality, smooth camera movement',
        icon: Film,
      },
      {
        category: 'Product',
        template:
          '[Product] rotating slowly, professional studio lighting, pristine white background',
        icon: Package,
      },
      {
        category: 'Audio Cue',
        template: 'Audio: [sound effect description]. Visual: [scene description]',
        icon: Volume2,
      },
      {
        category: 'Nature',
        template: 'Time-lapse of [natural phenomenon], golden hour lighting, wide angle lens',
        icon: Sunrise,
      },
    ],
    'runway-gen-4.5': [
      {
        category: 'Dynamic',
        template: '[Subject] with dynamic motion, energetic movement, cinematic quality',
        icon: Zap,
      },
      {
        category: 'Stylized',
        template: 'Stylized [scene], artistic interpretation, bold colors and composition',
        icon: Palette,
      },
    ],
    'kling-3.0': [
      {
        category: 'Cinematic',
        template: 'Cinematic [scene], smooth motion, professional quality',
        icon: Film,
      },
      {
        category: 'Creative',
        template: 'Creative interpretation of [subject], bold and expressive',
        icon: Palette,
      },
    ],
    'gpt-image-2': [
      {
        ...
        template: 'A professional photograph of [subject], high-quality, detailed, sharp focus',
        icon: Camera,
      },
      {
        category: 'Artistic',
        template: 'An artistic rendering of [subject] in the style of [art movement]',
        icon: Palette,
      },
      {
        category: 'Marketing',
        template: 'A modern marketing banner featuring [product], minimalist design, brand colors',
        icon: Monitor,
      },
    ],
    'flux-2-pro': [
      {
        ...
        template: 'Photorealistic image of [subject], commercial photography, perfect lighting',
        icon: Camera,
      },
      {
        category: 'Product Shot',
        template: 'Premium [product] photography, elegant packaging, lifestyle setting',
        icon: Package,
      },
      {
        category: 'Food',
        template: 'Appetizing [food item], professional food photography, natural lighting',
        icon: Coffee,
      },
    ],
    'imagen-4': [
      {
        category: 'Photorealistic',
        template: 'Photorealistic [subject], studio lighting, sharp detail, commercial quality',
        icon: Camera,
      },
      {
        category: 'Lifestyle',
        template: '[Subject] in a natural lifestyle setting, warm tones, editorial feel',
        icon: Sun,
      },
    ],
    'nano-banana-2': [
      {
        category: 'Lifestyle',
        template: '[Subject] in a natural setting, warm light, editorial feel',
        icon: Sun,
      },
      {
        category: 'Product',
        template: '[Product] on [background], clean and well-lit',
        icon: Package,
      },
    ],
    'nano-banana-pro': [
      {
        category: 'Hero Image',
        template: 'Ultra-photorealistic [subject], studio quality, incredible fine detail',
        icon: Camera,
      },
      {
        category: 'Product',
        template: 'Premium [product] photography, pristine textures, commercial grade quality',
        icon: Package,
      },
      {
        category: 'Lifestyle',
        template: '[Subject] in a cinematic lifestyle scene, golden hour, shallow depth of field',
        icon: Sun,
      },
    ],
  }
...
export const stylePresets = [
  ...
  { id: 'lifestyle', name: 'Lifestyle Shot', icon: Sun, description: 'Natural, everyday scenes' },
  {
    ...
    icon: Monitor,
    description: 'Eye-catching promotional',
  },
          ...
          <div className="absolute top-full left-0 mt-2 bg-slate-800 border border-slate-700 rounded-xl shadow-xl z-[9999] overflow-hidden min-w-full">
            {VIDEO_MODELS.map((model) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center text-lg ${model.id === 'veo-3.1' ? 'bg-purple-500' : model.id === 'runway-gen-4.5' ? 'bg-green-500' : 'bg-orange-500'}`}
                  >
                    {model.icon}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {model.supportsReferences ? (
                        <span className="text-xs px-1.5 py-0.5 rounded-full bg-teal-500/20 text-teal-300">
                          img → vid
                        </span>
                      ) : (
                        <span className="text-xs px-1.5 py-0.5 rounded-full bg-slate-600/60 text-slate-400">
                          prompt only
                        </span>
                      )}
                    </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <div className="flex items-center gap-2">
                <span className="text-white font-medium">{selectedModel?.name}</span>
                <span
                  className={`text-xs px-2 py-0.5 rounded-full ${badgeColor(selectedModel?.badge ?? '')}`}
                >
                  {selectedModel?.badge}
                </span>
              </div>
          ...
          <div className="absolute top-full left-0 mt-2 bg-slate-800 border border-slate-700 rounded-xl shadow-xl z-[9999] overflow-hidden min-w-full">
            {IMAGE_MODELS.map((model) => (
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`w-8 h-8 rounded-lg flex items-center justify-center text-lg ${model.id === 'gpt-image-2' ? 'bg-green-500' : model.id === 'flux-2-pro' ? 'bg-blue-500' : model.id === 'imagen-4' ? 'bg-sky-500' : model.id === 'nano-banana-pro' ? 'bg-orange-500' : 'bg-yellow-500'}`}
                  >
                    {model.icon}
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="text-white font-medium">{model.name}</span>
                      <span
                        className={`text-xs px-2 py-0.5 rounded-full ${badgeColor(model.badge)}`}
                      >
                        {model.badge}
                      </span>
                      {model.supportsReferences && (
  ...
  return (
    <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-xl p-4">
      ...
      >
        ...
        <span className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-medium text-sm">
          Browse Assets
        </span>
...
export function EnhancedTimeline({
  ...
  useEffect(() => {
    ...
    const smoothUpdate = () => {
      updateTime()
      if (!v.paused) animId = requestAnimationFrame(smoothUpdate)
    }
  ...
  return (
    <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-xl p-4">
      ...
      <div className="flex justify-between text-xs text-slate-400 mt-1">
        ...
        <span>{videoDur.toFixed(1)}s</span>
      </div>
...
export function QualitySettingsPanel({
  ...
  depthOfField: string
  tone: string
  noTextOrLogos: boolean
  onSettingsChange: (k: string, v: any) => void
}) {
  return (
    <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-xl p-4">
      <h3 className="text-sm font-semibold text-white mb-3 flex items-center gap-2">
        <Sliders className="w-4 h-4" /> Quality Settings
      </h3>
      <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2">
            {(['standard', 'high'] as const).map((q) => (
              <button
                ...
                className={`px-3 py-2 rounded-lg text-xs font-medium transition-colors capitalize ${quality === q ? 'bg-purple-500 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'}`}
              >
          ...
          <div className="grid grid-cols-2 gap-2">
            {lightingPresets.map((p) => {
              ...
              return (
                <button
                  key={p.id}
                  onClick={() => onSettingsChange('lighting', lighting === p.id ? '' : p.id)}
                  className={`p-2 rounded-lg text-xs font-medium transition-colors flex items-center justify-center gap-1 ${lighting === p.id ? 'bg-purple-500 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'}`}
                >
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {depthOfFieldPresets.map((p) => (
              <button
                key={p.id}
                onClick={() => onSettingsChange('depthOfField', depthOfField === p.id ? '' : p.id)}
                className={`px-2 py-1.5 rounded-lg text-xs font-medium transition-colors ${depthOfField === p.id ? 'bg-purple-500 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'}`}
              >
                {p.name}
              </button>
            ))}
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {tonePresets.map((p) => (
              <button
                key={p.id}
                onClick={() => onSettingsChange('tone', tone === p.id ? '' : p.id)}
                className={`px-2 py-1.5 rounded-lg text-xs font-medium transition-colors ${tone === p.id ? 'bg-purple-500 text-white' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'}`}
              >
                {p.name}
              </button>
            ))}
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative w-10 h-5 rounded-full transition-colors ${noTextOrLogos ? 'bg-purple-500' : 'bg-slate-700'}`}
          >
            <motion.div
...
export function PromptTemplatesPanel({
  ...
  return (
    <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-700 rounded-xl p-4">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-semibold text-white flex items-center gap-2">
          <BookOpen className="w-4 h-4" /> Prompt Helper
        </h3>
        <button
          ...
          >
            <div className="pt-3 border-t border-slate-700">
              <p className="text-xs font-medium text-white mb-2 flex items-center gap-1">
                <HelpCircle className="w-3 h-3" /> Model Tips
              </p>
