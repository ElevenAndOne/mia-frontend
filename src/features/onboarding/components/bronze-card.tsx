...
interface BronzeCardProps extends BronzeCardData {}
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div
          className={`${platformConfig.iconBg} w-10 h-10 rounded-lg flex items-center justify-center shadow-sm flex-shrink-0`}
        >
