...
export interface OnboardingActions {
  ...
  // Available platforms
  getAvailablePlatforms: () => Promise<{ platform: string; connected: boolean }[]>
...
export const OnboardingProvider: React.FC<OnboardingProviderProps> = ({ children }) => {
  ...
  const getAvailablePlatforms = useCallback(async (): Promise<{ platform: string; connected: boolean }[]> => {
    if (!sessionId) return []
