...
interface ProtectInsightsStreamingProps {
  onBack?: () => void
  initialDateRange?: string
  platforms?: string[]
}

const ProtectInsightsStreaming = ({ onBack, initialDateRange = '30_days', platforms }: ProtectInsightsStreamingProps) => {
      ...
      <div className="flex-1 bg-white p-6 pb-32 overflow-y-auto rounded-t-2xl -mt-4">
        ...
        {isStreaming && insights.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600 text-sm">Analyzing potential risks...</p>
          </div>
        )}
        ...
        {insights.length > 0 && !error && (
          <div className="space-y-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Key Risk Areas</h2>
...
export default ProtectInsightsStreaming
