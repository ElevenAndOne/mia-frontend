...
import { useStreamingInsightsParsed, type ParsedInsight } from '../hooks/use-streaming-insights-parsed'

// Helper component to render text with markdown links and campaign deep links
const MarkdownText = ({ text, className = '', metaAdsId }: { text: string; className?: string; metaAdsId?: string }) => {
