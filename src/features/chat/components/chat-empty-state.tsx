...
export const ChatEmptyState = ({ userName, children }: ChatEmptyStateProps) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto min-h-0">
      <div className="flex flex-col items-center min-h-full pt-4 pb-3 gap-3 justify-end md:gap-4 md:pb-4">
        <div className="md:flex-none flex items-center justify-center pb-2 md:pb-2">
