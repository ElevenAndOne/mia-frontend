...
export const ChatEmptyState = ({ userName, children }: ChatEmptyStateProps) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto min-h-0">
      <div className="flex flex-col items-center min-h-full pt-6 pb-3 gap-3 md:gap-6 md:pb-6">
        <div className="mt-auto md:flex-none flex items-center justify-center pb-4 md:pb-4">
