...
export const IconButton = forwardRef<HTMLButtonElement, IconButtonProps>(
  (
    ...
    const baseStyles = 'inline-flex items-center justify-center transition-colors focus:outline-hidden focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed'
