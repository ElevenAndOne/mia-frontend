                    ...
                    {insight.action && (
                      <div className="pl-10 bg-cyan-50 border-l-4 border-cyan-500 p-3 rounded">
                        <p className="text-sm text-gray-900 leading-relaxed font-medium" style={{ whiteSpace: 'pre-line' }}>
                          <span className="font-bold text-cyan-700">Action:</span> <MarkdownText text={insight.action} googleAdsId={selectedAccount?.google_ads_id} metaAdsId={selectedAccount?.meta_ads_id} />
                        </p>
                      </div>
                    )}
