                ...
                {insights.insights.map((insight, index) => (
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-5 space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="shrink-0 w-7 h-7 bg-orange-500 text-white rounded-full flex items-center justify-center text-sm font-bold">
                        {index + 1}
                      </div>
                    ...
                    {insight.action && (
                      <div className="pl-10 bg-orange-50 border-l-4 border-orange-500 p-3 rounded">
                        <p className="text-sm text-gray-900 leading-relaxed font-medium" style={{ whiteSpace: 'pre-line' }}>
                          <span className="font-bold text-orange-700">Action:</span> <MarkdownText text={insight.action} googleAdsId={selectedAccount?.google_ads_id} metaAdsId={selectedAccount?.meta_ads_id} />
                        </p>
                      </div>
                    )}
