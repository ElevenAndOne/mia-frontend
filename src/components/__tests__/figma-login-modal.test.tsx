...
describe('FigmaLoginModal', () => {
  ...
  describe('Google Authentication', () => {
    ...
    it('shows alert on Google authentication failure', async () => {
      ...
      await waitFor(() => {
        expect(globalThis.alert).toHaveBeenCalledWith('Authentication failed: Auth failed')
      })
    })
    ...
    it('handles Google authentication failure without error object', async () => {
      ...
      await waitFor(() => {
        expect(globalThis.alert).toHaveBeenCalledWith('Authentication failed. Please try again.')
      })
    })
  })
  ...
  describe('Meta Authentication', () => {
    ...
    it('shows alert on Meta authentication failure', async () => {
      ...
      await waitFor(() => {
        expect(globalThis.alert).toHaveBeenCalledWith('Meta authentication failed: Meta auth failed')
      })
    })
  })
  ...
  describe('Bypass Login', () => {
    ...
    it('handles bypass login failure', async () => {
      ...
      await waitFor(() => {
        expect(globalThis.alert).toHaveBeenCalledWith('Login bypass failed: Bypass failed')
      })
    })
  })
  ...
  describe('Email Button', () => {
    it('shows coming soon alert when email button is clicked', async () => {
      ...
      expect(globalThis.alert).toHaveBeenCalledWith('Email login coming soon!')
    })
  })
