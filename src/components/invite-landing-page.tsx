...
const InviteLandingPage = ({ inviteId, onAccepted, onBack }: InviteLandingPageProps) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen-dvh bg-linear-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
    ...
    <div className="min-h-screen-dvh bg-linear-to-br from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">
