...
import FigmaLoginModal from '../features/auth/views/figma-login-modal'
...
const IntroPage = ({ onAuthSuccess, onMetaAuthSuccess, hasSeenIntro = false, onOAuthPopupClosed }: IntroPageProps) => {
